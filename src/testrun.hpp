...
const SetType TESTS_DEBUG({"p465", "p466", "i160-245", "i160-325", "brasil58", "world666", "bipe2p", "e13", "cc3-5p", "cc6-2p", "hc8p"});
...
const SetType SETS_BENCHMARK({"SP", "X", "I080", "I160", "C", "D", "E", "I320"});
const SetType SETS_MODEST({"C", "D", "E"});
